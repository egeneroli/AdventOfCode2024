...
#
#             # check for X-MAS pattern by searching principal and secondary diagonals (flip mat horizontally and check again)
...
# parse into list of strings
data: np.array = np.array(read_input("input4test").split("\n"))
print(data)
